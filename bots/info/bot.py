...
# СИСТЕМА РАНГОВ В СЕПЛИЦА:

## 1. ИНТЕРЕСУЮЩИЙСЯ СЕПЛИЦЕЙ (Стартовый уровень)
**Условия получения:** Новый пользователь системы
**Возможности:** Изучение информации через инфо-бота, получение базовых знаний

## 2. СЕПЛИЦА-НЕОФИТ
**Условия получения:** 
- Изучить инфо-бота хотя бы на 70%
- Установить приложение Rejuvena
- Начать курс "Лебединая шея" или "Замедли старение"

**Возможности:**
- Бесплатный курс на исправление осанки "Лебединая шея" в приложении Rejuvena
- Может быть консультантом по установке приложения
- Продавец курса "Омолодись" с комиссией 10%
- Предлагается как консультант для помощи новым Интересующимся

## 3. СЕПЛИЦА-СПЕЦИАЛИСТ  
**Условия получения:**
- Полностью пройти курс обучения (14 дней)
- Пройти курс практики (30 дней) по курсу "Омолодись"
- Заполнить фотодневник
- Сдать коллаж "До и После" своему куратору

**Возможности:**
- Комиссия 30% от продажи курсов "Омолодись" (включая продвинутые)
- Предлагается как консультант для Интересующихся

## 4. СЕПЛИЦА-ЭКСПЕРТ (Высший уровень)
**Условия получения:**
- Пройти все продвинутые курсы "Омолодись"
- Сдать коллажи своему куратору

**Возможности:**
- Комиссия 45% от продажи
- Предлагается как консультант для Интересующихся
- Максимальный уровень экспертизы в системе

# ВАЖНО: 
У нас есть 2 системы прогресса:
1. Ранги (Интересующийся → Неофит → Специалист → Эксперт) - статус и возможности заработка
2. Ступени изучения (1-4) - глубина погружения в практики системы. Можно получать выгоды только от зарядки и советов по питанию, а можно делать дополнительный тюнинг лица, осанки, и на клеточном уровне - это уже требует вложений.
